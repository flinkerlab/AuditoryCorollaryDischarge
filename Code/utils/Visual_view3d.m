...
switch nargin
    case 1
        ...
        colormap('jet'); colorbar; caxis([2, 10]);
    ...
    case 2
        ...
        fig1 = figure;
        ax(1)=subplot(1,2,1); im1 = imagesc(img(:,:,slice)); colormap jet; title('image 1'); caxis([2,10]);

        ax(2)=subplot(1,2,2); im2 = imagesc(real(rec(:,:,slice))); colormap jet; title('image 2');caxis([2,10]);
